<?php require('includes/header.php'); ?>
    ...
    <div class="px-3 py-3">
        ...
        <p>A sua privacidade é importante para nós. É política do Estou de volta respeitar a sua privacidade em relação
            a
            qualquer informação sua que possamos coletar no site <a href=http://estoudevolta.epizy.com />Estou de
            volta</a>,
        ...
        <h2>Política de Cookies Estou de volta</h2>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Estou de volta oferece no
            site e
        ...
        <ul>
            ...
            <li>B) Não divulgar conteúdo ou propaganda de natureza racista, xenofóbica, <a
                    ...
                    style='color: inherit;font-weight: normal;text-decoration:none;'>casas de apostas legais</a>,
                pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Estou de volta, de seus
